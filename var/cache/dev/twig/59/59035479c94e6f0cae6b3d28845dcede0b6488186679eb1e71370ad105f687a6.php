...
class __TwigTemplate_8b561ffdc467571a59d90e9cd6d0f6019e7a40f0b17045347035ac8c7ac2d129 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <span class=\"info-box-icon";
        ...
        echo "\"><i class=\"";
        echo twig_escape_filter($this->env, (((isset($context["icon"]) || array_key_exists("icon", $context))) ? (_twig_default_filter((isset($context["icon"]) || array_key_exists("icon", $context) ? $context["icon"] : (function () { throw new RuntimeError('Variable "icon" does not exist.', 3, $this->source); })()), "info-circle")) : ("info-circle")), "html", null, true);
        echo "\"></i></span>
...
", "@AdminLTE/Widgets/infobox-widget.html.twig", "/var/www/GestionClub/vendor/kevinpapst/adminlte-bundle/Resources/views/Widgets/infobox-widget.html.twig");
    }
}
