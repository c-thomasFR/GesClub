...
class __TwigTemplate_52dafd6862b9a6c848875d6ac6f5ca0b2de3f1a04f0fd0d560ee81bc3a56c489 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_login_box_error($context, array $blocks = [])
    {
        ...
        // line 28
        echo "                    ";
        if ((((isset($context["error"]) || array_key_exists("error", $context))) ? (_twig_default_filter((isset($context["error"]) || array_key_exists("error", $context) ? $context["error"] : (function () { throw new RuntimeError('Variable "error" does not exist.', 28, $this->source); })()), false)) : (false))) {
            // line 29
    ...
    public function block_login_form($context, array $blocks = [])
    {
        ...
        // line 35
        echo "            <form action=\"";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath($this->extensions['KevinPapst\AdminLTEBundle\Twig\AdminExtension']->getRouteByAlias("adminlte_login_check"));
        echo "\" method=\"post\">
                ";
        // line 36
        ...
        echo "\" value=\"";
        echo twig_escape_filter($this->env, (((isset($context["last_username"]) || array_key_exists("last_username", $context))) ? (_twig_default_filter((isset($context["last_username"]) || array_key_exists("last_username", $context) ? $context["last_username"] : (function () { throw new RuntimeError('Variable "last_username" does not exist.', 38, $this->source); })()), "")) : ("")), "html", null, true);
        echo "\">
    ...
    public function block_login_actions($context, array $blocks = [])
    {
        ...
        // line 70
        echo "                ";
        if (($this->extensions['KevinPapst\AdminLTEBundle\Twig\AdminExtension']->getRouteByAlias("adminlte_password_reset") != "adminlte_password_reset")) {
            // line 71
            echo "                    <a href=\"";
            echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath($this->extensions['KevinPapst\AdminLTEBundle\Twig\AdminExtension']->getRouteByAlias("adminlte_password_reset"));
            echo "\">
                        ";
            // line 72
        ...
        // line 76
        echo "                ";
        if (($this->extensions['KevinPapst\AdminLTEBundle\Twig\AdminExtension']->getRouteByAlias("adminlte_registration") != "adminlte_registration")) {
            // line 77
            echo "                    <a href=\"";
            echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath($this->extensions['KevinPapst\AdminLTEBundle\Twig\AdminExtension']->getRouteByAlias("adminlte_registration"));
...
", "@AdminLTE/layout/security-layout.html.twig", "/var/www/GestionClub/vendor/kevinpapst/adminlte-bundle/Resources/views/layout/security-layout.html.twig");
    }
}
