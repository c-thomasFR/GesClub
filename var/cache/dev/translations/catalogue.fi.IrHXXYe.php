...
$catalogue = new MessageCatalogue('fi', array (
  ...
  'AdminLTEBundle' => 
  array (
    'Toggle navigation' => 'Vaihda navigoinnin tilaa',
    'Remember Me' => 'Muista minut',
    'Sign in to start your session' => 'Kirjaudu sisään aloittaaksesi',
    'Sign In' => 'Kirjaudu',
    'Sign out' => 'Kirjaudu ulos',
    'Profile' => 'Profiili',
    'Member since %date%' => 'Jäsen lähtien %date%',
    'Username' => 'Käyttäjätunnus',
    'Password' => 'Salasana',
    'Show homepage' => 'Kotisivu',
    'Back to login' => 'Takaisin',
    'Reset your password' => 'Nollaa salasanasi',
    'I forgot my password' => 'Unohtuiko salasana',
    'Register a new account' => 'Rekisteröi uusi tili',
    'View all' => 'Näytä kaikki',
    'You have %count% notifications' => 'Sinulla on 1 uusi ilmoitus|Sinulla on %count% uutta ilmoitusta',
    'You have %count% messages' => 'Sinulla on 1 uusi viesti|Sinulla on %count% uutta viestiä',
    'You have %count% tasks' => 'Sinulla on 1 tehtävä|Sinulla on %count% tehtävää',
    '%progress%% Complete' => '%progress%% Suoritettu',
    'This is a mandatory field' => 'Tämä on pakollinen kenttä',
  ),
));
