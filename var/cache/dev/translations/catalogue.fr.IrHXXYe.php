...
$catalogue = new MessageCatalogue('fr', array (
  ...
  array (
    ...
    'Sign in to start your session' => 'Connexion',
    'Sign In' => 'Connexion',
    ...
    'Register a new account' => 'Créer un compte',
    'View all' => 'Voir tout',
    'You have %count% notifications' => 'Vous avez une notification|Vous avez %count% notifications',
    'You have %count% messages' => 'Vous avez un message|Vous avez %count% messages',
    'You have %count% tasks' => 'Vous avez une tâche|Vous avez %count% tâches',
    '%progress%% Complete' => '%progress%% réussi',
    'This is a mandatory field' => 'Ce champ est obligatoire',
  ),
));
