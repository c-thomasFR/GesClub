...
$catalogue = new MessageCatalogue('tr', array (
  ...
  'AdminLTEBundle' => 
  array (
    'Toggle navigation' => 'Menüyü Aç/Kapa',
    'Remember Me' => 'Beni Hatırla',
    'Sign in to start your session' => 'Giriş',
    'Sign In' => 'Giriş',
    'Sign out' => 'Çıkış',
    'Profile' => 'Profilim',
    'Member since %date%' => '%date% tarihinden beri üye',
    'Username' => 'Kullanıcı adı',
    'Password' => 'Şifre',
    'Show homepage' => 'Anasayfayı göster',
    'Back to login' => 'Giriş sayfasına dön',
    'Reset your password' => 'Şifreyi sıfırla',
    'I forgot my password' => 'Şifremi unuttum',
    'Register a new account' => 'Yeni hesap aç',
    'View all' => 'Tümünü göster',
    'You have %count% notifications' => '1 yeni bildiriminiz var|%count% bildiriminiz var',
    'You have %count% messages' => '1 yeni mesajınız var|%count% yeni mesajınız var',
    'You have %count% tasks' => '1 göreviniz var|%count% göreviniz var',
    '%progress%% Complete' => '%progress%% tamamlandı',
    'This is a mandatory field' => 'Zorunlu alan',
  ),
  'FOSUserBundle' => 
  array (
